...
<div className="aai-card" style={{marginBottom: '2rem'}}>
  <div className="row">
    ...
    <div className="col col--9">
      <h3 style={{marginBottom: '0.25rem'}}>Elizabeth Pepper, MD</h3>
      <p style={{
      ...
      <p>
        Dr. Elizabeth Pepper is a Board Certified Allergist and Immunologist dedicated to improving patient care through evidence-based medicine. She specializes in the treatment of asthma, allergic rhinitis, food allergies, and primary immunodeficiency.
      </p>
      <p>
